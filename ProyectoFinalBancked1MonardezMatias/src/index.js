...
mongoose.connect("mongodb+srv://matiasezequielmza1425:matias1425.@mati.ctz5j.mongodb.net/?retryWrites=true&w=majority")
    .then(async () => {
...
const swaggerOptions = {
    definition: {
        ...
        info: {
            ...
            description: "Proyecto Backend  para aprobar curso Backend de Coderhouse"
        }
    },
